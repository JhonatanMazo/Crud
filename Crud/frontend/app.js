function consulta_general() {
    ...
    const visualizar = (data) => {
        ...
        for (let i = 0; i < data.baul.length; i++) {
          ...
          <td><button type="button" class="btn btn-info" onclick="location.href = 'edit.html?variable1=${data.baul[i].id_baul}'">Editar</button></td>
          <td><button type="button" class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})">Eliminar</button></td>
        </tr>`;
        }
